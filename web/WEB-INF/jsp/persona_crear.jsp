...
<body>
	...
	<div class="about-heading">
		<h2>Crear <span>Estudiante</span></h2>
	</div>
	<!-- //about-heading -->
			...
			<div class="signin-form profile">
				...
				<div class="login-form">
					<form action="personaRegistrar.htm" method="post">
                                            ...
                                            <input type="text" name="apellido_estudiante" placeholder="Apellido Estudiante" required>
                                            ...
                                            <input type="text" name="codigo_matricula" placeholder="Codigo Matricula" required="">
                                            <input type="text" name="codigo_contrato" placeholder="Codigo Contrato" required="">
                                            <input type="text" name="codigo_programa" placeholder="Codigo Programa" required="">
